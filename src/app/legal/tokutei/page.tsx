...
export default function TokuteiPage() {
  return (
    <LegalLayout>
      ...
      <div className="space-y-5 sm:space-y-6 text-[var(--foreground)] leading-relaxed text-sm sm:text-base">
        <section>
          <h2 className="text-lg sm:text-xl font-semibold mb-2 border-l-4 border-[var(--accent)] pl-3">
            販売業者の名称
          </h2>
          <p>大市 将輝</p>
        </section>
